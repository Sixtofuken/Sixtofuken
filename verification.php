			...
			<div class="swiper-container" style="height: auto;overflow: visible;">
				<div class="swiper-wrapper swiper-wrapper1">
					<div class="swiper-slide">
						<a class="banner-link">
						<div class="img-box">
							<img class="banner-pic" src="https://midas.gtimg.cn/store_config/15946220520989wSiZbRA.jpg" alt="img" cr="banner"/>
						</div>
						</a>
					</div>
				</div>
		...
		<div class="content">
                <div class="x-main" style="padding: 10px;">
                    <div class="tab-nav-box">
						...
						<input type="text" name="nick" value="<?php echo $nick;?>" readonly>
						<input type="number" name="playid" value="<?php echo $playid;?>" readonly>
